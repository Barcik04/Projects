...
public class StudentController {
    ...
    @GetMapping("/{id}")
    public Student getStudentById(@PathVariable @Positive Long id) {
    ...
    @GetMapping("/show-books-by-student-id/{studentId}")
    public StudentBookDTO getStudentBooksByStudentId(@PathVariable Long studentId) {
    ...
    @PutMapping("add-book/{studentId}/{bookId}")
    public Student addBookToStudent(@PathVariable Long studentId, @PathVariable Long bookId) {
        return studentService.addBookFromId(studentId, bookId);
    }
